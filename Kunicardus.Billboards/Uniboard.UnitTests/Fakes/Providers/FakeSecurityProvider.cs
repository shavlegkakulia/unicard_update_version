...
{
    class FakeSecurityProvider:ICustomSecurityProvider
    {
        ...
        public UserModel GetCredentials()
        {
           ...
           //var fbID = prefs.GetString("fbID", "");
            ...
            UserModel model = new UserModel
            {
                UserName = "smamuchishvili@gmail.com",//DecryptStringAES(username, Constants.SecurityKey),
                Password = "bulvari111",// DecryptStringAES(password, Constants.SecurityKey),
                FbToken = "CAAGRCsZCXYrsBAIlnRYxNlWzd2PSukqZAEPVUWJYDkQZCdG53cmTZB7EWIzCPHkBZBav2EcuRBkwCElTudPQcZBeYWJmjp46dh05pb2fPN45XJepF4WvHeqtxnPVfc8xFNIaHboPPktKoYZAu4o3Eu2cO5jSEUq9kSDd5L8zxDiyh4H0cBQVZBEReldesJDPfrEsWEvwsX5mUgZDZD"
            };
            return model;
        }
    }
