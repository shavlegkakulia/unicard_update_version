	...
	public class KuniTextField : UIView
	{
		...
		public override void LayoutSubviews ()
		{
			...
			_field.AttributedPlaceholder = 
				new NSAttributedString (_placeHolder, UIFont.FromName (Styles.Fonts.BPGExtraSquare, UIFont.LabelFontSize - 3), 
				UIColor.Clear.FromHexString (Styles.Colors.PlaceHolderColor));
			...
			AddSubview (_field);
			_line.BackgroundColor = UIColor.Clear.FromHexString (Styles.Colors.Yellow);
