...
//				}
		...
		public ICommand CheckInfoClickedCommand {
			get { 
				_checkInfoClicked = _checkInfoClicked ?? new MvvmCross.Commands.MvxCommand (CheckPaymentInfo);
		...
		public ICommand BuyProductCommand {
			get { 
				_buyProductCommand = _buyProductCommand ?? new MvvmCross.Commands.MvxCommand (BuyProduct);
