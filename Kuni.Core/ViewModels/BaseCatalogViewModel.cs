...
namespace Kuni.Core
{
    public class BaseCatalogViewModel : MvxViewModel
    {
        ...
        //			get {
        //				_searchCommand = _searchCommand ?? new MvvmCross.Commands.MvxCommand (Search);
        ...
        public ICommand DrawerItemSelectedCommand
        {
            get
            {
                _drawerItemSelectedCommand = _drawerItemSelectedCommand ?? new MvvmCross.Commands.MvxCommand<CategoryModel>(SelectCategory);
